...
<head>
    ...
    <title>Login - Village Monitoring System</title>
...
<body class="bg-gray-50">
    <nav class="bg-white shadow-sm fixed w-full z-10">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="desktop-menu hidden md:flex items-center space-x-4">
                        ...
                        <a href="register.php" class="flex items-center space-x-2 bg-primary text-white px-4 py-2 rounded-button text-sm font-medium hover:bg-primary/90">
                            <i class="ri-user-add-line w-4 h-4"></i>
                            <span>Sign Up</span>
                        </a>
                    </div>
                </div>
            ...
            <div id="mobile-menu" class="mobile-menu hidden md:hidden bg-white shadow-sm">
                ...
                <a href="register.php" class="block text-gray-900 hover:text-primary px-4 py-2 text-sm font-medium">Sign Up</a>
            </div>
        </div>
    </nav>
    ...
    <main class="max-w-7xl mx-auto px-4 py-20 md:py-24 flex items-center justify-center min-h-screen">
        <div class="bg-white p-6 md:p-8 rounded-lg shadow-sm w-full max-w-md">
            <h2 class="text-2xl md:text-3xl font-['Pacifico'] text-primary mb-6 text-center">Login</h2>
            <?php if (isset($error)): ?>
            ...
            <div class="mt-4 text-center text-sm">
                ...
                <p class="mt-2">Don't have an account? <a href="register.php" class="text-primary hover:underline">Sign Up</a></p>
            </div>
        </div>
    </main>
